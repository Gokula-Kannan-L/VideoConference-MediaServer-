...
const RemoteTile:FunctionComponent<RemoteProps> = ({videoStream, audioStream, userName, userKey, audio, video, avatar, isPinned}) => {
        ...
        <div className="remote-user" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
            ...
            }
            {
                ...
                <div className="video-pin">
                    {isPinned ? 
                        <div className="pin-icon" onClick={ () => pinVideo(false, userKey)}>
                            <FlashOffIcon/> 
                        </div>
                        :
                        <div className="pin-icon" onClick={ () => pinVideo(true, userKey)}>
                           <FlashOnIcon/>
                        </div>
                    }
                </div>
