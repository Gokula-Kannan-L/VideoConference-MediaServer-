...
const Dialogbox = () => {
    const {dialogOpen, setDialogOpen, startScreenShare, presenter} = useGlobalState();
    return(
        <Dialog open={dialogOpen} className='dialog-box' sx={{}}>
            ...
            <DialogActions sx={{margin:"5px"}}>
                ...
                <Button sx={{backgroundColor: "#4CBB17"}} onClick={() => startScreenShare()} variant="contained">Share now</Button>
            </DialogActions>
        </Dialog>
    )
}
