...
const MeetControls = () => {
    const {audio, video, isScreenSharing, toggleAudio, toggleVideo, handleScreenShare, stopScreenShare, leaveMeeting, startRecording, stopRecording, presenter, setDialogOpen} = useGlobalState();
    const [toggleSettings, setToggleSettings] = useState<boolean>(false);
    const Settings = () => {
        return(
            <List className="settings-main">
                <ListItemButton className="settings-items" onClick={ () => startRecording()}>Start Recording</ListItemButton>
                <ListItemButton className="settings-items" onClick={ () => stopRecording()}>Stop Recording</ListItemButton>
            </List>
        )
    }
    ...
    return(
        <div className="controls">
            ...
            {isScreenSharing ?
                ...
                :
                <div className="screen" onClick={startScreenShare}>
