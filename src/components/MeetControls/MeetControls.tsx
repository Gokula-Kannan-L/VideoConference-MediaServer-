...
const MeetControls = () => {
    const {audio, video, isScreenSharing, toggleAudio, toggleVideo, handleScreenShare, stopScreenShare, leaveMeeting, isHost, muteAllUsers, startRecording, stopRecording, endMeeting} = useGlobalState();
