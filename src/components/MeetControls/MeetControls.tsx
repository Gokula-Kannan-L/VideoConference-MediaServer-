...
const MeetControls = () => {
    const {audio, video, screenShare, toggleAudio, toggleVideo, handleScreenShare, leaveMeeting} = useGlobalState();
    ...
    return(
        <div className="controls">
            ...
            <div className={screenShare ? "stop-share" : "screen"} onClick={() => handleScreenShare()}>
                {screenShare ?
