...
export const GlobalProvider = (props: {children: ReactNode}):ReactElement => {
    ...
    const recordTransport = useRef<MediasoupTypes.Transport | null>(null);
    ...
    return(
    <GlobalContext.Provider value={{ localStream, InitialiseMeeting, meetStateRef, participants, toggleAudio, toggleVideo, audio, video, screenShare, displayStream, chatMessages, sendMessage, leaveMeeting, handleScreenShare}}>
        {props.children}
