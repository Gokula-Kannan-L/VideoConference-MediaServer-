...
export const GlobalProvider = (props: {children: ReactNode}):ReactElement => {
        ...
        if(meetStateRef.current && socketRef.current){
            ...
            socket.onmessage = async(event: MessageEvent) => {
                ...
                switch(type){
                    ...
                    case "newUser":
                            if(response.user){
                                const {userKey, userName, preference, producer} = response.user;
    ...
    return(
    <GlobalContext.Provider value={{ localVideoRef, InitialiseMeeting, meetStateRef, participants, toggleAudio, toggleVideo}}>
        {props.children}
