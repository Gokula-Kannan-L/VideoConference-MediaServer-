...
export const GlobalProvider = (props: {children: ReactNode}):ReactElement => {
    ...
    return(
    <GlobalContext.Provider value={{ localStream, InitialiseMeeting, meetStateRef, participants, toggleAudio, toggleVideo, audio, video, chatMessages, sendMessage, leaveMeeting}}>
        {props.children}
